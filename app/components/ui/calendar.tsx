...
import { de, es, fr, it, ja, ko, nl, pt, zhCN } from "react-day-picker/locale";
...
function Calendar({
  ...
  const currentLocale = propLocale || (i18n.language as keyof typeof localeMap);
  const dateLocale = localeMap[currentLocale];
    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString(currentLocale === "es" ? "es-ES" : "en-US", {
            month: "short",
          }),
        ...formatters,
      }}
